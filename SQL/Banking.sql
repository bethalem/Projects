...
--------------------------------------------------------------------------------
/* Question 1      SQL function that accepts a principal mortgage amount    */
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
/*Question 2  find the ID and customer name of each customer at the bank who only has a loan at the bank, and no account.        		  		          */
--------------------------------------------------------------------------------
    ------------------------------- Part (a) -----------------------------
...
WHERE dep.ID = cust.ID)
 ...
 ------------------------------- Part (b) ------------------------------
/* find the ID and customer name of each customer who lives on the same street and in the same city as customer ‘12345’.
...
-- Customer ID 12345 is also included ---
  ...
  ------------------------------- Part (c) ------------------------------
		/* Write a query to find the name of each branch that has at least one
		customer who has an account in the bank and who lives in “Harrison”.*/
...
--------------------------------------------------------------------------------
/*Question 3      On delete of an account, for each customer-owner of the account,
...
--------------------------------------------------------------------------------
/*	Question 4  a procedure that accepts an instructor ID as input.         		  		          */
--------------------------------------------------------------------------------
